...
class PilotColorPalette {
  const PilotColorPalette({
    required this.blue,
    required this.cyan,
  ...
  final PilotColorShades blue;
  final PilotColorShades cyan;
  final PilotColorShades geekblue;
  final PilotColorShades gold;
  final PilotColorShades green;
  final PilotColorShades lime;
  final PilotColorShades magenta;
  final PilotColorShades orange;
  final PilotColorShades pink;
  final PilotColorShades purple;
  final PilotColorShades red;
  final PilotColorShades volcano;
  final PilotColorShades yellow;

  static const light = PilotColorPalette(
    blue: _lightBlue,
    cyan: _lightCyan,
  ...
  static const dark = PilotColorPalette(
    blue: _darkBlue,
    cyan: _darkCyan,
  ...
  PilotColorPalette lerp(PilotColorPalette other, double t) {
    return PilotColorPalette(
...
class PilotColorShades {
  const PilotColorShades({
  ...
  PilotColorShades lerp(PilotColorShades other, double t) {
    return PilotColorShades(
...
const _lightBlue = PilotColorShades(
...
const _lightCyan = PilotColorShades(
...
const _lightGeekblue = PilotColorShades(
...
const _lightGold = PilotColorShades(
...
const _lightGreen = PilotColorShades(
...
const _lightLime = PilotColorShades(
...
const _lightMagenta = PilotColorShades(
...
const _lightOrange = PilotColorShades(
...
const _lightPurple = PilotColorShades(
...
const _lightRed = PilotColorShades(
...
const _lightVolcano = PilotColorShades(
...
const _lightYellow = PilotColorShades(
...
const _darkBlue = PilotColorShades(
...
const _darkCyan = PilotColorShades(
...
const _darkGeekblue = PilotColorShades(
...
const _darkGold = PilotColorShades(
...
const _darkGreen = PilotColorShades(
...
const _darkLime = PilotColorShades(
...
const _darkMagenta = PilotColorShades(
...
const _darkOrange = PilotColorShades(
...
const _darkPurple = PilotColorShades(
...
const _darkRed = PilotColorShades(
...
const _darkVolcano = PilotColorShades(
...
const _darkYellow = PilotColorShades(
