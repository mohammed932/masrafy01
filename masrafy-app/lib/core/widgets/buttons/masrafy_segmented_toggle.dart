...
class MasrafySegmentOption<T> {
  final T value;
  final String label;
  final IconData icon;

  const MasrafySegmentOption({
    required this.value,
    required this.label,
    required this.icon,
  });
...
class MasrafySegmentedToggle<T> extends StatelessWidget {
  const MasrafySegmentedToggle({
    super.key,
  ...
  final List<MasrafySegmentOption<T>> options;
