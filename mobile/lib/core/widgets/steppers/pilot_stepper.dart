...
class PilotStepperItem {
  final String label;
  final IconData? icon;

  const PilotStepperItem({required this.label, this.icon});
}

/// Inline horizontal stepper matching the Figma "Steps" component:
/// [number circle] [label] [connector line] … [number circle] [label]
class PilotStepper extends StatelessWidget {
  final int currentStep;
  final List<PilotStepperItem> steps;
  ...
  Widget build(BuildContext context) {
    ...
    final textTheme = PilotTextTheme.of(context);
...
class _StepWithConnector extends StatelessWidget {
  final int index;
  final PilotStepperItem item;
  final bool isActive;
  final bool isCompleted;
  final PilotColorTheme colors;
  final PilotTextTheme textTheme;
