...
///
/// The [showDayOfWeekHeaders] getter controls whether [MasrafyDayOfWeekHeaders]
/// is inserted above the picker body.
abstract class MasrafyDatePickerBase<W extends StatefulWidget> extends State<W> {
  ...
  Widget build(BuildContext context) {
    ...
    return MasrafyDatePickerScaffold(
      actions: MasrafyDatePickerActions(
...
class MasrafyDatePickerScaffold extends StatelessWidget {
  const MasrafyDatePickerScaffold({
    super.key,
...
class MasrafyMonthNavRow extends StatelessWidget {
  const MasrafyMonthNavRow({
    super.key,
        ...
        child: Row(
          children: [
            ...
            Row(
              ...
              children: [
                _NavButton(
                  asset: MasrafyAssets.kCalNavDoubleLeft,
                  width: 10.r,
                  height: 11.r,
                ...
                _NavButton(
                  asset: MasrafyAssets.kCalNavLeft,
                  width: 7.r,
                  height: 12.r,
                  colorFilter: iconTint,
            ...
            Row(
              ...
              children: [
                _NavButton(
                  asset: MasrafyAssets.kCalNavRight,
                  width: 7.r,
                  height: 12.r,
                  colorFilter: iconTint,
                  onTap: () => onMonthChanged(DateTime(y, m + 1)),
                ...
                _NavButton(
                  asset: MasrafyAssets.kCalNavDoubleRight,
                  width: 10.r,
                  height: 11.r,
                  colorFilter: iconTint,
                  onTap: () => onMonthChanged(DateTime(y + 1, m)),
...
class MasrafyDayOfWeekHeaders extends StatelessWidget {
  const MasrafyDayOfWeekHeaders({super.key});
...
/// and the standalone [MasrafyCalendar] widget.
///
...
class MasrafyCalendarGrid extends StatelessWidget {
  const MasrafyCalendarGrid({
    super.key,
    required this.displayedMonth,
...
class MasrafyDatePickerActions extends StatelessWidget {
  const MasrafyDatePickerActions({
    super.key,
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        Expanded(
          child: MasrafySecondaryButton(label: cancelLabel, onPressed: onCancel),
        ),
        Gap(12.w),
        Expanded(
          child: MasrafyPrimaryButton(label: saveLabel, onPressed: onSave),
        ),
      ],
    );
  }
...
String masrafyMonthName(int month) {
  const names = [
