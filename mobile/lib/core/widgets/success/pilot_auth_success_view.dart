...
import 'package:app/core/widgets/icons/pilot_success_check_icon.dart';
...
class PilotAuthSuccessView extends StatelessWidget {
  const PilotAuthSuccessView({
    super.key,
    required this.title,
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              _Logo(),
              Gap(32.h),
              const Center(child: PilotSuccessCheckIcon()),
              Gap(32.h),
              Text(
                title,
              ...
              Gap(32.h),
              PilotPrimaryButton(label: ctaLabel, onPressed: onCtaPressed),
            ],
          ),
        ),
      ),
...
class _Logo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final img = Image.asset(PilotAssets.pilotLogo, height: 48.h);
