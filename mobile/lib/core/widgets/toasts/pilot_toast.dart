...
/// Shared toast surface. Concrete subclasses (`PilotSuccessToast`,
/// `PilotErrorToast`, `PilotWarningToast`) supply the icon + tint;
...
/// Usage:
/// ```dart
/// const PilotSuccessToast(message: 'Flag updated').show(context);
/// ```
abstract class PilotToast {
  const PilotToast({required this.message, this.duration});

  final String message;
  final Duration? duration;

  String get iconAsset;
  Color backgroundColor(PilotColorTheme colors);
  Color foregroundColor(PilotColorTheme colors) => colors.white;
...
class _PilotToastView extends StatelessWidget {
  const _PilotToastView({
