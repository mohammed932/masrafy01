...
import 'package:app/core/widgets/common/masrafy_html.dart';
...
/// [bodyFontSize].
class MasrafyAnswerOption extends StatelessWidget {
  const MasrafyAnswerOption({
    super.key,
    required this.state,
    required this.label,
  ...
  final MasrafyAnswerOptionState state;
  final String label;
  ...
  Widget build(BuildContext context) {
    ...
    final borderWidth = state == MasrafyAnswerOptionState.selected ? 2.r : 1.2;
...
class MasrafyAnswerOptionPalette {
  const MasrafyAnswerOptionPalette({
    required this.bg,
...
MasrafyAnswerOptionPalette paletteFor(
  MasrafyAnswerOptionState state,
  MasrafyColorTheme colors,
) =>
    _paletteFor(state, colors);

MasrafyAnswerOptionPalette _paletteFor(
  MasrafyAnswerOptionState state,
  MasrafyColorTheme colors,
) {
  switch (state) {
    case MasrafyAnswerOptionState.correct:
      return MasrafyAnswerOptionPalette(
        bg: colors.success.bg,
        border: colors.success.active,
        text: colors.success.active,
      );
    case MasrafyAnswerOptionState.incorrect:
      return MasrafyAnswerOptionPalette(
        bg: colors.error.bg,
        border: colors.error.active,
        text: colors.error.active,
      );
    case MasrafyAnswerOptionState.revealedCorrect:
      return MasrafyAnswerOptionPalette(
        bg: colors.bg.container,
        border: colors.success.active,
        text: colors.success.active,
      );
    case MasrafyAnswerOptionState.selected:
      return MasrafyAnswerOptionPalette(
        bg: colors.fill.handleBg,
        border: colors.primary.main,
        text: colors.primary.main,
      );
    case MasrafyAnswerOptionState.idle:
      return MasrafyAnswerOptionPalette(
        bg: colors.fill.handleBg,
