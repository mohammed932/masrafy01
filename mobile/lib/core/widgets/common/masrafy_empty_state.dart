...
abstract class MasrafyEmptyState extends StatelessWidget {
  const MasrafyEmptyState({super.key});
...
class MasrafyFetchErrorState extends MasrafyEmptyState {
  const MasrafyFetchErrorState({super.key, required this.onRetry});
...
/// from `MasrafyAssets`). When both are passed, SVG wins.
class MasrafyNoItemsState extends MasrafyEmptyState {
  const MasrafyNoItemsState({
    super.key,
    IconData? icon,
    String? iconSvgAsset,
    ...
    VoidCallback? onAction,
          ...
          'MasrafyNoItemsState needs either an `icon` or `iconSvgAsset`',
        ),
        _icon = icon,
...
class MasrafyNoResultsState extends MasrafyEmptyState {
  const MasrafyNoResultsState({super.key, required this.onClearFilters});
