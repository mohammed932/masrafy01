...
///
/// Concrete subclasses (`MasrafyTextField`, future `MasrafyPhoneField`,
/// `MasrafyDropdown`, …) extend this. The rendering + state machine comes
/// from the `MasrafyInput` mixin — subclasses only need to build the actual
/// input widget.
