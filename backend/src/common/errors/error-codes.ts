...
export const ERROR_CODES = {
  ...
  // Prefill layers (admin)
  PREFILL_TARGET_INVALID: 'PREFILL_TARGET_INVALID',
  CATALOG_DEFAULTS_CATEGORY_UNKNOWN: 'CATALOG_DEFAULTS_CATEGORY_UNKNOWN',
...
export const ERROR_HTTP_STATUS: Record<ErrorCode, number> = {
  ...
  PREFILL_TARGET_INVALID: 400,
  CATALOG_DEFAULTS_CATEGORY_UNKNOWN: 422,
