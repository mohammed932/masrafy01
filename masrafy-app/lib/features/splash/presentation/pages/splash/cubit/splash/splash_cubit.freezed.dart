...
/// @nodoc
mixin _$SplashState {
  SplashDestination? get destination => throw _privateConstructorUsedError;
...
abstract class $SplashStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({SplashDestination? destination});
}
...
class _$SplashStateImpl extends _SplashState {
  const _$SplashStateImpl({this.destination}) : super._();
  ...
  @override
  String toString() {
    return 'SplashState(destination: $destination)';
  }
...
abstract class _SplashState extends SplashState {
  const factory _SplashState({final SplashDestination? destination}) =
      _$SplashStateImpl;
