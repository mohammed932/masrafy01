...
const COPY: Readonly<Record<string, () => BlueprintCopy>> = {
  armed_forces_grades: () => ({
    title: $localize`:@@bpl.armed.title:Armed forces, by grade`,
  ...
  academic_rank_table: () => ({
    title: $localize`:@@bpl.rank.title:University staff, by academic rank`,
  ...
  years_in_practice_bands: () => ({
    title: $localize`:@@bpl.years.title:Professionals, by years in practice`,
  ...
  card_limit_share: () => ({
    title: $localize`:@@bpl.card.title:A share of a credit-card limit`,
  ...
  auto_loan_crosssell: () => ({
    title: $localize`:@@bpl.auto.title:An existing car loan`,
  ...
  pledged_collateral_share: () => ({
    title: $localize`:@@bpl.pledged.title:Savings the customer will pledge`,
  ...
  school_stage_ceiling: () => ({
    title: $localize`:@@bpl.stage.title:Teachers, by the stage they teach`,
  ...
  company_coding_cap: () => ({
    title: $localize`:@@bpl.coding.title:How the employer is coded`,
  ...
  school_type_cap: () => ({
    title: $localize`:@@bpl.schooltype.title:The kind of school a teacher works at`,
  ...
  club_branch_cap: () => ({
    title: $localize`:@@bpl.club.title:A club membership, by branch`,
