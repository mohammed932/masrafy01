...
///
/// Uses the shared [MasrafyCalendarGrid] for pixel-perfect Figma parity.
/// A "Today" link is rendered below the grid with a top divider.
class MasrafySingleDatePickerSheet extends StatefulWidget {
  const MasrafySingleDatePickerSheet({
    super.key,
  ...
  @override
  State<MasrafySingleDatePickerSheet> createState() =>
      _MasrafySingleDatePickerSheetState();
}

class _MasrafySingleDatePickerSheetState
    extends MasrafyDatePickerBase<MasrafySingleDatePickerSheet> {
