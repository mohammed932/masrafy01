...
///
/// Use [PilotShareSheet.show] for the typical `Future<String?>` flow:
///
/// ```dart
/// final email = await PilotShareSheet.show(
///   context: context,
/// );
/// if (email != null) cubit.shareWith(email);
/// ```
class PilotShareSheet extends StatefulWidget {
  const PilotShareSheet({
    super.key,
  ...
  @override
  State<PilotShareSheet> createState() => _PilotShareSheetState();
}

class _PilotShareSheetState extends State<PilotShareSheet> {
