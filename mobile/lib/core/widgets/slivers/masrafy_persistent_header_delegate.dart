...
class MasrafyPersistentHeaderDelegate extends SliverPersistentHeaderDelegate {
  const MasrafyPersistentHeaderDelegate({
  ...
  @override
  bool shouldRebuild(covariant MasrafyPersistentHeaderDelegate oldDelegate) =>
