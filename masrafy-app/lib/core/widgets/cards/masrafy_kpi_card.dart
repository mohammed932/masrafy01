...
/// arrow/sparkline tint applied by [MasrafyKpiCard].
enum MasrafyTrendDirection { up, down, flat }
...
class MasrafyKpiCard extends StatelessWidget {
  const MasrafyKpiCard({
    super.key,
    required this.value,
    required this.label,
  ...
  final MasrafyTrendDirection trendDirection;
  ...
  Widget build(BuildContext context) {
    ...
    final trendColor = switch (trendDirection) {
      MasrafyTrendDirection.up => colors.primary.hover,
      MasrafyTrendDirection.down => colors.error.main,
      MasrafyTrendDirection.flat => colors.text.tertiary,
    };

    final trendLabelColor = switch (trendDirection) {
      MasrafyTrendDirection.up => colors.success.main,
      MasrafyTrendDirection.down => colors.error.main,
      MasrafyTrendDirection.flat => colors.text.tertiary,
    };
    ...
    final arrowAngle = switch (trendDirection) {
      MasrafyTrendDirection.up => 0.0,
      MasrafyTrendDirection.down => math.pi / 2,
      MasrafyTrendDirection.flat => -math.pi / 4,
    };
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: CustomPaint(
              painter: _MasrafyKpiSparklinePainter(
...
class _MasrafyKpiSparklinePainter extends CustomPainter {
  const _MasrafyKpiSparklinePainter({
  ...
  @override
  bool shouldRepaint(_MasrafyKpiSparklinePainter old) =>
      old.points != points ||
