...
import 'package:app/core/widgets/input_controls/masrafy_popup_menu.dart';

class MasrafyPeriodSelector<T> extends StatelessWidget {
  const MasrafyPeriodSelector({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return MasrafyPopupMenu<T>(
      selectedValue: selected,
      onSelected: onChanged,
      options: [
        for (var i = 0; i < options.length; i++)
          MasrafyPopupMenuOption(value: options[i], label: labels[i]),
      ],
      child: Container(
