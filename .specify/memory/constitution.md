...
scoring or eligibility fields, and (v10.0.0) NO category: they form a single
**GLOBAL question pool**. Each bank program **selects which questions it scores
...
is a single GLOBAL questionnaire (v10.0.0), NOT per category** — every applicant
answers the same pool; the chosen loan category only decides which *programs* are
matched, never which *questions* are asked. The questionnaire that
...
**Version**: 10.0.0 | **Ratified**: 2026-05-12 | **Last Amended**: 2026-07-24
