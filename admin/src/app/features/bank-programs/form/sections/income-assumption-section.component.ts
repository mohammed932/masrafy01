      ...
      <div class="grid">
        <mat-form-field appearance="outline" class="span-2">
          ...
          <mat-select formControlName="strategy">
            <mat-option value="declared" i18n="@@bank_programs.strategy.declared"
              >Declared (applicant-provided)</mat-option
            >
            <mat-option value="byYearsInJob" i18n="@@bank_programs.strategy.years_job"
              >By years in job</mat-option
            >
            <mat-option value="byYearsInPractice" i18n="@@bank_programs.strategy.years_practice"
              >By years in practice</mat-option
            >
            <mat-option value="byProfessorRank" i18n="@@bank_programs.strategy.professor_rank"
              >By professor rank</mat-option
            >
            <mat-option value="byMilitaryGrade" i18n="@@bank_programs.strategy.military_grade"
              >By military grade</mat-option
            >
            <mat-option value="byCDValue" i18n="@@bank_programs.strategy.cd_value"
              >By CD value</mat-option
            >
            <mat-option value="byCarInstallment" i18n="@@bank_programs.strategy.car_installment"
              >By car installment</mat-option
            >
            <mat-option value="byCarLoanAmount" i18n="@@bank_programs.strategy.car_loan_amount"
              >By car loan amount</mat-option
            >
            <mat-option value="byCreditCardLimit" i18n="@@bank_programs.strategy.credit_card_limit"
              >By credit card limit</mat-option
            >
            <mat-option
              value="byBankStatementPercent"
              i18n="@@bank_programs.strategy.bank_statement"
              >By bank statement percent</mat-option
            >
          </mat-select>
        </mat-form-field>
        ...
        @switch (strategy) {
          @case ('byCarInstallment') {
            <mat-form-field appearance="outline" class="numeric span-2">
              <mat-label i18n="@@bank_programs.field.car_installment_mult"
                >Car installment multiplier</mat-label
              >
              <input
                matInput
          ...
          @case ('byCarLoanAmount') {
            <mat-form-field appearance="outline" class="numeric span-2">
              <mat-label i18n="@@bank_programs.field.car_loan_pct"
                >Car loan amount percent</mat-label
              >
              <input
                matInput
          ...
          @case ('byCreditCardLimit') {
            <mat-form-field appearance="outline" class="numeric span-2">
              <mat-label i18n="@@bank_programs.field.cc_limit_mult"
                >Credit card limit multiplier</mat-label
              >
              <input
                matInput
          ...
          @case ('byBankStatementPercent') {
            <mat-form-field appearance="outline" class="numeric span-2">
              <mat-label i18n="@@bank_programs.field.bank_statement_pct"
                >Bank statement percent</mat-label
              >
              <input
                matInput
