...
export const ERROR_CODES = {
  ...
  OPTION_MISSING_SCORE_VALUE: 'OPTION_MISSING_SCORE_VALUE',
  ...
  SCORING_FACTOR_NOT_FOUND: 'SCORING_FACTOR_NOT_FOUND',
  WEIGHT_SET_NOT_FOUND: 'WEIGHT_SET_NOT_FOUND',
  WEIGHTS_MUST_SUM_TO_100: 'WEIGHTS_MUST_SUM_TO_100',
  WEIGHTS_UNKNOWN_FACTOR: 'WEIGHTS_UNKNOWN_FACTOR',
  WEIGHT_SET_NOT_DRAFT: 'WEIGHT_SET_NOT_DRAFT',
  WEIGHT_SET_NOT_PENDING: 'WEIGHT_SET_NOT_PENDING',
  APPROVER_MUST_DIFFER_FROM_MAKER: 'APPROVER_MUST_DIFFER_FROM_MAKER',
...
export const ERROR_HTTP_STATUS: Record<ErrorCode, number> = {
  ...
  OPTION_MISSING_SCORE_VALUE: 422,
  ENABLED_WHEN_INVALID: 422,
  QUESTION_IN_USE: 409,
  QUESTION_OPTION_IN_USE: 409,
  REQUIRED_ANSWER_MISSING: 422,
  PROGRAM_NO_LONGER_MATCHES: 409,
  SCORING_FACTOR_NOT_FOUND: 404,
  WEIGHT_SET_NOT_FOUND: 404,
  WEIGHTS_MUST_SUM_TO_100: 422,
  WEIGHTS_UNKNOWN_FACTOR: 422,
  WEIGHT_SET_NOT_DRAFT: 409,
  WEIGHT_SET_NOT_PENDING: 409,
  APPROVER_MUST_DIFFER_FROM_MAKER: 403,
