...
abstract class $ProfileStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({RequestState status, ProfileData? data, Failure? error});
...
class _$ProfileStateImpl extends _ProfileState {
  const _$ProfileStateImpl(
      {this.status = RequestState.initial, this.data, this.error})
      : super._();
  ...
  @override
  String toString() {
    return 'ProfileState(status: $status, data: $data, error: $error)';
  }
...
abstract class _ProfileState extends ProfileState {
  const factory _ProfileState(
      {final RequestState status,
      final ProfileData? data,
      final Failure? error}) = _$ProfileStateImpl;
