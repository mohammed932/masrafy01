        ...
        <aside class="brand-panel" aria-hidden="true">
          <div class="brand-content">
            ...
            <div class="tagline">
              ...
              <p i18n="@@auth.login.subtitle">
                Match Egyptian borrowers with the best bank loan programs — at scale.
              </p>
            </div>
            ...
            <ul class="stats">
              <li>
                ...
                <span class="stat-text"
                  ><strong>20+</strong
                  ><em i18n="@@auth.login.stat.bank_programs">Bank Programs</em></span
                >
              </li>
              <li>
                <span class="stat-icon"><i nz-icon nzType="team" nzTheme="outline"></i></span>
                <span class="stat-text"
                  ><strong i18n="@@auth.login.stat.marketplace_value">Live</strong
                  ><em i18n="@@auth.login.stat.marketplace">Lead Marketplace</em></span
                >
              </li>
              <li>
                ...
                ></span>
                <span class="stat-text"
                  ><strong>99.9%</strong><em i18n="@@auth.login.stat.uptime">Uptime SLA</em></span
                >
              </li>
            </ul>
            ...
            <form [formGroup]="form" (ngSubmit)="submit()" novalidate class="login-form">
              <div class="field" [class.has-error]="showError('email')">
                ...
                @if (form.controls.email.touched && form.controls.email.errors?.['required']) {
                  ...
                  <span class="field-error" i18n="@@login.email.invalid"
              ...
              <div class="field" [class.has-error]="showError('password')">
                ...
                @if (
                  ...
                  <span class="field-error" i18n="@@login.password.required"
    ...
    `
      ...
      .login-container {
        ...
        background:
          ...
          radial-gradient(ellipse at 80% 100%, rgba(161, 124, 91, 0.1) 0%, transparent 50%),
          var(--bg-base);
        overflow: hidden;
      }
      ...
      .orb-2 {
        width: 460px;
        height: 460px;
        background: radial-gradient(circle, rgba(161, 124, 91, 0.2), transparent 70%);
        bottom: -160px;
        right: -140px;
      }
      .orb-3 {
        width: 360px;
        height: 360px;
        background: radial-gradient(circle, rgba(8, 105, 195, 0.1), transparent 70%);
        top: 50%;
        left: 50%;
      ...
      .security-pill {
        ...
        font-weight: 500;
        color: var(--bronze-300);
        background: rgba(212, 184, 159, 0.1);
      ...
      .header-badge {
        ...
        color: var(--primary);
        background: linear-gradient(135deg, rgba(8, 105, 195, 0.1), rgba(8, 105, 195, 0.04));
      ...
      .field.has-error input:focus {
        box-shadow: 0 0 0 4px rgba(193, 102, 107, 0.16);
      }
      ...
      [dir='rtl'] .submit-btn:hover:not(:disabled) .btn-arrow {
        transform: translateX(-4px);
      }
