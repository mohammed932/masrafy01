...
class MasrafyFlipCard extends StatefulWidget {
  const MasrafyFlipCard({
    super.key,
    required this.front,
    required this.back,
  ...
  @override
  State<MasrafyFlipCard> createState() => _MasrafyFlipCardState();
}

class _MasrafyFlipCardState extends State<MasrafyFlipCard>
    ...
    return Center(
      child: GestureDetector(
        ...
        child: Row(
          ...
          children: [
            SvgPicture.asset(
              MasrafyAssets.kStudyCopyTwotone,
              width: 18.r,
              height: 18.r,
