...
///
/// Use [PilotRenameSheet.show] for the typical `Future<String?>` flow:
///
/// ```dart
/// final newName = await PilotRenameSheet.show(
///   context: context,
///   currentName: test.name,
/// );
/// if (newName != null) cubit.rename(test.id, newName);
/// ```
class PilotRenameSheet extends StatefulWidget {
  const PilotRenameSheet({
    super.key,
  ...
  static Future<String?> show({
    ...
    return PilotBottomSheetBase.show<String>(
      context: context,
      sheet: PilotRenameSheet(
  ...
  @override
  State<PilotRenameSheet> createState() => _PilotRenameSheetState();
}

class _PilotRenameSheetState extends State<PilotRenameSheet> {
